...
const createOfferCourseSection = async (req: Request): Promise<IGenericResponse> => {
...
const getAllOfferCourseSections = async (req: Request): Promise<IGenericResponse> => {
...
const getSingleOfferCourseSection = async (req: Request): Promise<IGenericResponse> => {
  const { id } = req.params;
...
const updateOfferCourseSection = async (req: Request): Promise<IGenericResponse> => {
  const { id } = req.params;
...
const deleteOfferCourseSection = async (req: Request): Promise<IGenericResponse> => {
  const { id } = req.params;
...
export const OfferedCourseSectionService = {
  ...
  getAllOfferCourseSections,
  getSingleOfferCourseSection,
